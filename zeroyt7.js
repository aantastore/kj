...
creator = 'Xynta Store' // GAK USAH DI UBAH ANJING HARGA CREATOR
recode = 'XYNTA STORE' // UBAH NAMA LU
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done tod jangan lupa follow ig @suranta_smbr_',
			error: {
...
JANGAN LUPA SUBSCRIBE YOUTUBE ZERO YT7
https://youtube.com/ZeroYT7
`
...
but = [
        ...
        sendButImage(from, teks, "©Xynta Store", gam, but)
break
case 'gopay':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "GOPAY : 081262411188 (Anta store )", faketeks, but, mek)
break
case 'dana':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "DANA : 081262411188 (Anta store )", faketeks, but, mek)
break
case 'ovo':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
sendButton(from, "OVO : 081262411188 (anta store )", faketeks, but, mek)
break
case "runtime":
case "test":
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
